<?php
	...
	$sql="SELECT * FROM $tbl_name JOIN members ON members.member_id = topic.member";
...
<!-- Question 1c: add header cell -->

<td width="13%" align="center" bgcolor="#E6E6E6"><strong>Name</strong></td>
</tr>
