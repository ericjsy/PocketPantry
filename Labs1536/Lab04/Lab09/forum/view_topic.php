<?php
	...
	$sql="SELECT * FROM $tbl_name JOIN members ON members.member_id = topic.member where id='$id'";
...
<tr>
<td bgcolor="#F8F7F1"><strong>By :</strong> <? echo $rows['firstname']; ?></td>
</tr>
...
// Question 1d: need to fix up SQL to get first name!
...
<!-- Question 1d: Add first name here!! -->

<td width="77%" bgcolor="#F8F7F1"></td><?=$rows['firstname']; ?>
</tr>
<tr>
